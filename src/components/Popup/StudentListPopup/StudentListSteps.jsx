...
export default function StudentListSteps({ handleClose , handleAddStudentDetails}) {
  ...
  const studentListDetails = {
    StudentName : `${studentDetails.FirstName} ${studentDetails.MiddleName} ${studentDetails.LastName}`,
    RollNo : studentDetails.RollNo,
    Gender : studentDetails.Gender,
    DOB : studentDetails.DOB,
    StudentID : "1234"
  }
  async function submitHandler(studentListDetails){
    ...
    const response = await fetch("http://localhost:4000/StudentListDetails", {
      ...
      body: JSON.stringify(studentListDetails)
    });
    // console.log(studentListDetails);
    alert("Data Saved");
    closeModal();
    handleAddStudentDetails(studentListDetails);
  }
    ...
    <Modal handleClose={closeModal} isOpen={showModal}>
      <div className={classes.container}>
        ...
        <span className={classes.parentbutton}>
          ...
          {step === 3 && (
            <button className={classes.submitbutton} onClick={()=>submitHandler(studentListDetails)}>
              <span> Save</span>
            </button>
          )}
        </span>
