...
const FacultyCard = ({ name, leaveReason, avatarSrc, altText }) => (
  <div className="flex gap-[16px] mt-1 rounded-lg leading-[120%]">
    <img
      loading="lazy"
      src={avatarSrc}
      alt={altText}
...
const AbsentRateCard = ({ absentClassName }) => (
  <div className="flex gap-[19px] mt-1 rounded-lg leading-[120%] h-[45px]">
    {/* <div className="flex "> */}
...
function PerformanceAnalytics() {
  ...
  return (
    <div className="flex col-span-full flex-col p-4  bg-white rounded-[20px] shadow-dashboardShadow  overflow-x-auto ">
      {/* py-4 pl-4 */}
      ...
      <div className="mt-1 max-md:max-w-full">
        ...
        <div className="flex gap-4  max-md:flex-col max-md:gap-0 overflow-x-auto scrollbarnone ">
          <div className="flex flex-col shrink-0 w-[38%] max-md:ml-0 max-md:w-full">
