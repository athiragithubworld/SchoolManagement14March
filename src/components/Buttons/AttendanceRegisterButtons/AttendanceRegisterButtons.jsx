...
const Buttons = ({handleDeleteSelectedRows,selectedRows,
  // props from ui/DeletePopup
  handleChangeClass,handleChangeSection}) => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "http://localhost:4000/AttendanceRegister"
        );
        if (!response.ok) {
