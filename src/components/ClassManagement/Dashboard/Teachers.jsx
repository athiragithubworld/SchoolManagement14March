    ...
    <div className="flex gap-2 p-2 hover:bg-blue-100 rounded-[14px] shadow-primary  w-full md:w-[calc(50% - 1rem)]">
      ...
      <div className="flex-grow flex gap-4 justify-between">
        ...
        <div className="flex flex-col">
          <span className="leading-6">{teacher.name}</span>
...
const Teachers = () => {
  ...
  return (
    <section className="flex  col-span-full flex-col p-4  text-black bg-white rounded-[20px] shadow-dashboardShadow w-full h-[266px]">
