...
const AbsentCard = ({ image, name, reason }) => (
  <div className="flex  shrink-0 sm:flex-row gap-2 justify-center items-center p-2 mt-2 text-base leading-5 text-black bg-white rounded-[14px] border border-solid shadow-primary border-stone-300">
    ...
    />
    <div>
      <div className="flex-1 flex justify-between w-[250px] my-auto text-wrap text-sm text-left sm:text-left">
        <span className="font font-bold ">{name}</span>
        <span className="text-[#3c3c3c]">3 days leave</span>
      </div>
...
const ClassManagementAbsentees = () => {
  ...
  return (
    <div className="flex flex-col p-4 col-span-full shrink-0  bg-white rounded-[20px] shadow-dashboardShadow leading-[120%] md:max-h-[380px] lg:min-h-[16.25rem] ">
