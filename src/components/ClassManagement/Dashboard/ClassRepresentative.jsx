...
export const ClassRepresentative = ({setShowClassRepresentativePopup}) => {
  return (
    <div className="flex flex-col col-span-full gap-3 w-full h-[266px] rounded-[20px] p-4 shadow-dashboardShadow overflow-y-scroll scrollbarnone">
      <table className=" overflow-y-scroll">
        <thead className="font-bold text-start text-lg">
          Class Representative
        </thead>

        <tbody className="flex flex-col gap-3 w-full overflow-y-scroll table-scrollbar h-full py-1">
          <tr
          ...
          {classRepresentativeDetails.map(
            (classRepresentativeDetail, index) => (
              <tr
                key={index}
              ...
              >
                ...
                <td className="w-20 h-fit text-[18px] text-center font-bold">
                  {classRepresentativeDetail.classRepresentative}
                </td>
              </tr>
            )
          )}
